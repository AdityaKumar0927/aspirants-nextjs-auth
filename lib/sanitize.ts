...
// NOTE: cleanText() moved to lib/clean-text.ts so admin routes that only need
// plain-text cleaning don't transitively import isomorphic-dompurify (which
// fails to load in Vercel's serverless bundles).
