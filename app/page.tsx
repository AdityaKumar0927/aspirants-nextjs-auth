  ...
  return (
    <>
      <div className="z-10 w-full max-w-xl px-5 xl:px-0">
        ...
        <h1
          className="animate-fade-up bg-gradient-to-br from-blue-500 to-blue-300 bg-clip-text text-center font-display text-4xl font-bold tracking-[-0.02em] text-transparent opacity-0 drop-shadow-sm sm:text-5xl sm:leading-[5rem]"
