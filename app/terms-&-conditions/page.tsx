  ...
  return (
    <div className="min-h-screen bg-background text-foreground py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-muted-foreground mb-8">Effective Date: 24th June 2024</p>

        <Card className="mb-8">
          <CardContent className="p-6">
            <p className="text-sm text-muted-foreground">
              These Terms and Conditions of Use apply to the Aspirants website located at www.aspirants.tech. BY USING THE SITE, YOU AGREE TO THESE TERMS OF USE; IF YOU DO NOT AGREE, DO NOT USE THE SITE.
            </p>
          </CardContent>
        </Card>
        ...
        <ScrollArea className="h-[calc(100vh-200px)] pr-4">
          <div className="space-y-8">
            ...
            <Section title="Use of the App">
              <p className="text-sm text-muted-foreground mb-4">
                You may need to create an Aspirants account to use all or part of our Service. Your username and password are for your personal use only and should be kept confidential. You understand that you are responsible for all use (including any unauthorized use) of your username and password.
              </p>
              <p className="text-sm text-muted-foreground mb-4">
                You may use our Services only for lawful personal use, and in accordance with these Terms and Conditions. Aspirants may, in its sole discretion, terminate your right to use our Services at any time, and may take all available legal recourse for actual or suspected violations of these Terms and Conditions.
              </p>
              <p className="text-sm text-muted-foreground mb-4">
            ...
            <Section title="Contact">
              <p className="text-sm text-muted-foreground">
                By using our Site, you acknowledge that you have read, understood, and agreed to these Terms and Conditions. If you have any questions, concerns, or feedback, please contact us at aspirants.contact@gmail.com.
              </p>
            </Section>
          </div>
        </ScrollArea>
