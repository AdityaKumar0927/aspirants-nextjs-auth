...
export default function TermsAndConditions() {
  return (
    <div className="min-h-screen bg-background dark:bg-gray-900 text-foreground dark:text-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-2 text-gray-900 dark:text-gray-100">Terms of Service</h1>
        <p className="text-muted-foreground dark:text-gray-400 mb-8">Effective Date: 24th June 2024</p>
