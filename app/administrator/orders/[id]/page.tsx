...
import { DescriptionDetails, DescriptionList, DescriptionTerm } from '@/components/administrator-ui/description-list'
...
import { Link } from '@/components/administrator-ui/link'
import { getOrder } from 'app/administrator/data'
  ...
  return (
    <>
      <div className="max-lg:hidden">
        <Link href="/issues" className="inline-flex items-center gap-2 text-sm/6 text-zinc-500 dark:text-zinc-400">
