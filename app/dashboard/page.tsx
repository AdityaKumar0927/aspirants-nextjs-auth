              ...
              <TabsContent value="overview" className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">Mathematics Paper 2 & Physics Paper 3, 2018</div>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">Economics 2019</div>
                      <p className="text-xs text-muted-foreground">
                        50 Questions
                      </p>
                    </CardContent>
                ...
                <Link href="/customize">
                  <Button>Create Custom Question Bank</Button>
                </Link>
              </TabsContent>
            </Tabs>
          </div>
