...
const Sidebar = () => {
  ...
  return (
    <div className="fixed top-16 left-4 w-20 h-8/12 my-56 flex flex-col items-center py-8 space-y-12 bg-white bg-opacity-20 backdrop-blur-lg rounded-xl border border-white border-opacity-30 shadow-lg">
