...
interface DialogProps extends Omit<React.ComponentPropsWithoutRef<typeof Headless.Dialog>, 'as' | 'className' | 'unmount'> {
...
export function Dialog({
  ...
  return (
    <Headless.Dialog {...props} onClose={onClose} unmount={false}>
