...
export default function Question({
  ...
  return (
    <TooltipProvider>
      {/* 
         Add border-2 and conditionally color the border
         Green if completed, else Yellow if flagged, else default 
      */}
      <div
        {...handlers}
...
// Sub-component for nested comments
